...
<body>
     <script type = "text/javascript" >
          history.pushState(null, null, 'Result.jsp');
...
<div class="card" id="mpt">
  <h5 class="card-header">Result output</h5>
  <div class="card-body mt-3">
   ...
   <%
     List<Wallet> fin=data.Database.getallwallet((String)session.getAttribute("pin"));
   ...
   session.setAttribute("code", "error");
      response.sendRedirect("paymentreceipt.jsp");
        ...
        out.println("<tr><th>Pmt ID</th><th>Date</th><th>Status</th><th>Wallet ID</th><th>Amount</th><th>Balance</th></tr>");
     for(Wallet f:fin){
        

    out.println("<tr><td>"+f.getPin()+"</td><td>"+f.getDate()+"</td><td>Successful</td><td>"+f.getAccount()+"</td><td>"+f.getCredit()+"</td><td>"+f.getBalance()+"</td></tr>");
      ...
      %>
       <hr />
          ...
          <div class="col-sm-1"></div>        
              ...
              <center>
                  <b>Services offered at kambok and given by <%=name%> </b>
              </center>
          </div>
          </div>
