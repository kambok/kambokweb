        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">       
            <div class="position-sticky pt-md-5">
                <ul class="nav flex-column mx-3" id="navbar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="investorpassport.jsp">
            ...
            <div class="row d-flex justify-content-center py-5">
                <div class="col-md-6">
                    <div class="container">
                        ...
                        <br><br>
                        <form action="InvestorPassport" method="post" enctype="multipart/form-data">                                            
                            <div class="mb-5 mx-auto text-center">
                                <input type="hidden" name="email" value="<%=s.getEmail()%>">
                                <input type="file" name="passport" id="passport" class="inputfile" />
                                <label for="passport"><i class="fa-solid fa-upload"></i> Choose passport</label>
                            </div>
