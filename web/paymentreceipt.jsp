...
document.getElementById('dis').innerHTML=val; 
  ...
  <script type="text/javascript">
    ...
    <body>
        <script type = "text/javascript" >
          history.pushState(null, null, 'paymentreceipt.jsp');
...
<div class="card">
  ...
  <div class="card-body mt-3">
      <form class="row g-3" name="myform" action="Paymentreceipt">
                            <div class="col-md-9">
                              <label for="colname" class="form-label">Enter Pin or Email</label>
                              <input type="text" required="required" placeholder="Pin or Email"  class="form-control" id="pin" name="pin">
                            </div>
      ...
      <br />
      <strong id="report" class="text-danger" style="visibility: hidden;">Invalid code</strong>
  </div>
...
if(session.getAttribute("code")!=null && c.equals("error")){
