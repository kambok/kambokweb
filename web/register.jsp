...
<body>
    ...
    <div class="container p-3">
        <div class="row d-flex justify-content-center align-items-center py-3 vh-100 m-5" >
              <div class="row d-flex justify-content-center align-items-center">
                  <div class="col-md-12">
                      <div class="logo-container text-center">
                          <img class="rounded-circle shadow" src="kam.png" alt="logo" width="100px">
                          <h4 class="text-secondary">KAMBOK LOAN</h4>
                      </div>
                  </div>
              </div>
            <div class="row d-flex justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 col-xl-6 col-sm-12 col-xs-12">
