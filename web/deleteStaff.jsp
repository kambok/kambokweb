...
<body>
     <script type = "text/javascript" >
          history.pushState(null, null, 'deleteStaff.jsp');
...
<h1 class="h2 text-primary text-center">Admin Authentication</h1>
    ...
    <div class='row d-flex justify-content-center'>
        <div class='col-md-8'>
            <div id="delete-user-section">
                        ...
                        <form class='form py-4' action='DeleteStaff' method='post'>
                           <div class='row d-flex justify-content-center'>
                               <div class='col-md-8'>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" placeholder="Enter Password" required="required"  id='adminPin2' onmouseout="validateInput()">
                                </div>
                            </div> 
                        </div>
                               </div>
                            ...
                            <input type='hidden' id='adminPin' value='<%=p%>'>
                       
                            <button type='submit' class="btn btn-danger mx-3" id='delete' onmouseenter='validateAdminPin()'style="width: 150px; font-size: 20px;">Delete</button>
  ...
  <ul class="nav m-0">
      ...
      <li class="nav-item">
        <a class="nav-link text-secondary" href="#">Contact</a>
            ...
            if(p2 == ""){
               document.getElementById("adminPin2").placeholder = "Required field";
                document.getElementById("adminPin2").style.borderColor = "red";
                document.getElementById("delete").disabled = true;
            }else{
                document.getElementById("adminPin2").placeholder = p2.value;
                document.getElementById("adminPin2").style.borderColor = "lightgrey";
                document.getElementById("delete").disabled = false;
            }
