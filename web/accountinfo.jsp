...
if(email!="" && acctname!="" && acctno!="" && bankname!=""){
  
var url="savaBank?email="+email+"&acctname="+acctname+"&acctno="+acctno+"&bankname="+bankname;
...
<body>
     ...
     <script>
        history.pushState(null,'accountinfo.jsp', location.href);
...
<div class="position-sticky pt-md-5">
  <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="accountinfo.jsp">
...
<p>You can update your account information</p>
        </div>
       </div>
    
    <br>
     <strong id="dis"></strong>
<div class="card">
  ...
  <div class="card-body">
      <form name="myform">
       <div class="row">
          <div class="col-sm-4">
            <input type="text" name="acctname" id="cid" placeholder="Account name" value="<%=us.getAcctname()%>"> 
          </div>
          <div class="col-sm-4">
        <input type="text" name="acctno" id="cid" placeholder="Account number" value="<%=us.getAcctno() %>">
        <input type="hidden" name="email"  placeholder="Account number" value="<%=us.getEmail() %>">
          </div>
        <div class="col-sm-4"><input type="text" id="cid" placeholder="Bank name" name="bankname" value="<%=us.getBankname()%>"></div>
      </div> 
      ...
      <div class="col-12 d-flex justify-content-center">
          <button type="button" class="btn btn-success" onclick="sendInfo();">Save Info</button>
    </div> 
      </div>
      </form>
 </div>
