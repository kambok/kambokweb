...
<div class="position-sticky pt-md-5">
  <ul class="nav flex-column" id="navbar">
      <li class="nav-item active">
          <a class="nav-link active" aria-current="page" href="settings.jsp">
                        ...
                        <div class="form-outline mb-4">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" class="form-control"   name="password" id="pass2" value="<%=us.getPassword()%>">
               ...
               <div class="row">
                ...
                <div class="col-md-5 model text-center  ">
                   <h1>Change Password</h1>
                    ...
                    <input type="hidden" class="form-control"  name="email" value="<%=us.getEmail()%>">
