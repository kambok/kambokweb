...
<div class="card">
  <h3 class="card-header d-flex align-items-center" >Approved Loan &nbsp<div id="beepBox" class="spinner-grow text-primary text-center" role="status" style="width: 20px; height: 20px;">
                <span class="visually-hidden"></span>
                </div></h3>
  <div class="card-body" id="amtcard">
      <h2 class="card-title">Get a loan btw the approved amount<br /> <span class="text-success" style="border: none;outline: none;background-color:transparent;">from ₦1,000 to ₦<input style="border: none;outline: none;background-color:transparent; font-weight: bold;" class="text-success" type="text" id="amount" value="<%=us.getAmount()%>"></span></h2>
      <input type="hidden" id="status" value="<%=us.getStatus()%>" style="border: none;outline: none;background-color:transparent;">
      <p class="card-text"><a href="loanapp.jsp">Proceed/Apply</a></p>
    <p class="card-text text-success">Terms and conditions apply</p>
  </div>
</div>
      <script>
  ...
  var beep = document.getElementById("beepBox");
      if((a==null || a=="null") || b!="Approved"){
        document.getElementById("amtcard").innerHTML="Not available"; 
        beep.style.width = 0;
        beep.style.height = 0; 
      } 
      </script>
