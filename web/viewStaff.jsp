...
<body>
     <script type = "text/javascript" >
          history.pushState(null, null, 'viewStaff.jsp');
...
<div class="container-fluid">
<h1 class="h2 text-primary text-center">Staff Information</h1>

<section class="staff-management-section container">
    <div class="row my-4">
        <div id="view-user-section">
                       <div class="breadcrumb lt p-3">
                        <div class="row ">
                        <div class="col-md-12">
                            <div class="row text-r d-flex">
                                 <div class="col">
                                     <p class="light-text">First Name</p>
                                    <h4 class="text-dark rt"><%= staff.getFirstname() %></h4>
                                 </div>
                                 <div class="col">
                                     <p class="light-text">Last Name</p>
                                    <h4 class="text-dark rt"><%= staff.getLastname() %></h4>
                                 </div>
                             </div>
                             <br>
                             <div class="row text-r d-flex">
                                 <div class="col">
                                     <p class="light-text">Position</p>
                                    <h4 class="text-dark rt"><%= staff.getPosition() %></h4>
                                 </div>
                                 <div class="col">
                                     <p class="light-text">Telephone</p>
                                    <h4 class="text-dark rt"><%= staff.getPhone() %></h4>
                                 </div>
                             </div>
                             <div class="row text-r d-flex">
                                 <div class="col">
                                     <p class="light-text">Email address</p>
                                    <h4 class="text-dark rt"><%= staff.getEmail() %></h4>
                                 </div>
                                 <div class="col">
                                     <p class="light-text">Status</p>
                                    <h4 class="text-dark rt">Active</h4>
                                 </div>
                             </div>
                        </div>
                    </div>      
