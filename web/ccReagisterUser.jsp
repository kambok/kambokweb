<%-- 
    Document   : ccReagisterUser
    Created on : Jul 17, 2022, 6:29:11 PM
    Author     : Depittaz
--%>
...
<body>
     <script type = "text/javascript" >
          history.pushState(null, null, 'ccReagisterUser.jsp');
...
%>
 ...
 <%
    ...
    if(us.getEmail()!=null && us.getPosition().equals("Customer Care")){
...
<div class="position-sticky pt-md-5">
  <ul class="nav flex-column">
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="ccReagisterUser.jsp">
            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl- col-xs-12 col-sm-12">
              <div class="card form-container" style="border-radius: 1rem;">
                <div class="card-body p-5 text-center">
                    ...
                    <form action="CustomerCareRegistry" method="post">
                        <!-- First name input -->
                        ...
                        <input type="hidden" class="form-control" name="registeredBy" value="<%=us.getEmail() %>">                   
                        <!-- Submit button -->
