...
var sender=document.myform.sender.value;


var url="DebitClient?id="+pin+"&email="+email+"&amount="+amount+"&sender="+sender;
...
<body>
     <script type = "text/javascript" >
          history.pushState(null, null, 'confirmpayment.jsp');
  ...
  <ul class="nav flex-column">
      <li class="nav-item">
        ...
        <a class="nav-link active" href="confirmpayment.jsp">
          ...
          <span class="ml-2">Load Wallet</span>
        </a>
         </li>
    </ul>
</div>
...
<div class="card">
  <h5 class="card-header">Load Wallet</h5>
  
  <div class="card-body">
      <b id="ccf"></b>
      <form class="row g-3" name="myform">
                            <div class="col-md-10">
                              <label for="colname" class="form-label">Wallet Number or Email</label>
                              <input type="text" required="required"  onchange="sendInfo();" class="form-control" id="id" name="id">
                            </div>
          <div class="col-md-10">
                              <label for="colname" class="form-label">Name Identification</label>
                              <input type="text" required="required" readonly="readonly"  class="form-control" id="name" name="name">
                            </div>
          <div class="col-md-10">
                              <label for="colname" class="form-label">Credit Amount</label>
                              <input type="text" required="required"  class="form-control" id="amount" name="amount">
                              <input type="hidden" required="required" placeholder="Credit amount" class="form-control" id="sender" value="<%=name%>" name="sender">
                            </div>
          <div class="col-12">
                            
              <input type="button" class="btn btn-secondary"  value="Send" onclick="sendInfo2();">
                            </div>
       </form>
       
    
      <strong id="report" class="justify-content-between text-danger" style="visibility:hidden;">Invalid pin or pin already been validated</strong>
  </div>
