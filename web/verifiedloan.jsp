...
<body>
     <script type = "text/javascript" >
          history.pushState(null, null, 'verifiedloan.jsp');
...
<div class="card">
  <h5 class="card-header">Verified payment</h5>
  <div class="card-body">
      <%
     List<CollateralVerify>lts= data.Database.getverifiedloan(session);
       for(CollateralVerify cl:lts){
      out.println("<table class='table'><tr><td>"+cl.getFirstname()+"</td><td>"+cl.getLastname()+"</td><td>"+cl.getVerificationid()+"</td><td>"+cl.getLoanamount()+"</td><td><form action='paymentreview.jsp'><input type='hidden' name='pin' value='"+cl.getVerificationid()+"'><input type='submit' class='btn btn-primary' value='view'></form></td></tr></table>");
       }
      %>
  </div>
