...
<body>
     <script type = "text/javascript" >
          history.pushState(null, null, 'Pickupreceipt.jsp');
...
%>
    ...
    <%!String name="",lastname="",position="",email="",pic1="",pic2="";
    ...
    if((position.equals("Admin") || position.equals("Finance")) && (!email.equals("") || email!=null)){
        ...
        fc=data.Database.getfinance2((String)session.getAttribute("pmtid"));
        if(fc!=null){
      ...
      <div class="row">
          ...
          <div class="col-sm-10">
              ...
              <table class="table">
                  ...
                  <tr>
                      <th>Sender</th>
                      <td><%=fc.getSendername()%></td>
                      <th>Method</th>
                      <td><%=fc.getPmtmethd()%></td>
                      <th>Purpose</th>
                      <td><%=fc.getPmtpurpose()%></td>
                      <th>Status</th>
                      <td><%=fc.getStatus()%></td>
                  </tr>
          ...
          <div class="col-sm-1"></div>        
              ...
              <center>
                  <b>Services offered at kambok and given by <%= fc.getAgentname()%> </b>
              </center>
          </div>
          </div>
