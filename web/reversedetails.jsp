...
<div class="card">
  ...
  <div class="card-body">
      ...
      %>
      <form class="row g-3" name="myform" action="finance">
                            <div class="col-md-4">
                              <label for="colname" class="form-label">Payment ID</label>
                              <input type="text" readonly class="form-control" id="total" value="<%=Admin.PaymentCodegenerator.generateRegno()%>" name="ps">
                            </div>
            <div class="col-md-4">
                              <label for="colname" class="form-label">Verified ID</label>
                              <input type="text" readonly onchange="calculate();" class="form-control" id="deposit" value="<%=cv.getVerificationid()%>" name="vcid">
                            </div>
            <div class="col-md-4">
                              <label for="colname" class="form-label">Transaction ID</label>
                              <input type="text" readonly class="form-control" id="balance" value="<%=cv.getTrid()%>" name="trid">
                            </div>
                      <div class="col-md-4">
            ...
            <div class="col-md-4">
                              ...
                              <input type="text" readonly class="form-control" id="senderid" value="<%=cv.getEmail()%>" name="email">
                            </div>
                       <div class="col-md-4">
                              <label for="colname" class="form-label">Phone</label>
                              <input type="text" readonly  readonly class="form-control" id="trid" value="<%=cv.getPhone()%>" name="phone">
                            </div>
            <div class="col-md-4">
             ...
             <div class="col-md-4">
                              ...
                              <input type="text" readonly class="form-control" id="sendername" value="<%=cv.getTime()%>" name="time">
                            </div>
                            
            <div class="col-md-4">
                              <label for="colname" class="form-label">Vstatus</label>
                              <input type="text" readonly readonly class="form-control" id="pmtid" value="<%=cv.getStatus()%>" name="pmtid">
                            </div>
            <div class="col-md-4">
                              <label for="colname" class="form-label">No(Expired)</label>
                              <input type="text" readonly readonly class="form-control" id="agentname" value="" name="expired">
                            </div>
                              <div class="col-md-4">
                              <label for="colname" class="form-label">No(Extension)</label>
                              <input type="text" readonly class="form-control" id="agentid" value="" name="extension">
                            </div>
             <div class="col-md-4">
                              <label for="colname" class="form-label">No(Liquidate)</label>
                              <input type="text" readonly readonly class="form-control" id="agentid" value="" name="liquidate">
                            </div>
            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                              ...
                              <input type="text" readonly  class="form-control"  value="" name="pamt">
                            </div>
                            <div class="col-md-4">
                              <label for="colname" class="form-label">P(interest)</label>
                              <input type="text" readonly  class="form-control"  value="" name="pint" >
                            </div>
                            <div class="col-md-4">
                              <label for="colname" class="form-label">P(Total)</label>
                              <input type="text" readonly class="form-control"  value="" name="ptotal">
                            </div>
                             <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="text"  readonly class="form-control"  value="<%=cv. getAcctno()%>" name="aactno" >
                            </div>
                             <div class="col-md-4">
                              <label for="colname" class="form-label">Agent Name</label>
                              <input type="text" readonly class="form-control"  value="<%=firstname +" "+lastname%>" name="agentname">
                            </div>
                            <div class="col-md-4">
          ...
          <div class="col-6">
                <label for="colname" class="form-label"></label><br /> <br /><br />           
