<%-- 
    Document   : printLoanAgreement
    Created on : Jul 20, 2022, 6:38:07 AM
    Author     : Depittaz
--%>
...
var url="PrintLoanAgreement?trid="+trid;
...
<body>
     <script type = "text/javascript" >
          history.pushState(null, null, 'printLoanAgreement.jsp');
...
<div class="position-sticky pt-md-5">
  <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link  active" href="printLoanAgreement.jsp">
            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl- col-xs-12 col-sm-12">
              <div class="card form-container" style="border-radius: 1rem;">
                <div class="card-body p-5 text-center">
                    <form action="PrintLoanAgreement" method="post" name="myform" target="_blank">
                        
                        <div class="row mt-3">
                            <div class="col-md-9">
                                <input type="text" class="form-control" placeholder="Transaction ID" aria-label="trid" name="trid" id="trid" required>
                            </div>
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-primary btn-block mb-4 submitBtn">Search</button>
                            </div>
