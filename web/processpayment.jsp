...
<div class="card">
  <h5 class="card-header">Process payment</h5>
  <div class="card-body mt-3">
      <form class="row g-3" name="myform" action="paymentreview.jsp">
                            <div class="col-md-10">
                              <label for="colname" class="form-label">Enter verified ID or phone number</label>
      ...
      <a href="verifiedloan.jsp" target="_new"><button type="button" class="btn btn-primary">
              List Of Verified Loan <span class="badge bg-deanger"><%=session.getAttribute("num")%></span>
  </button></a>
  </div>
